...
public class UIInput : MonoBehaviour
{
    ...
    protected void Init()
    {
        if (mDoInit && label != null)
        {
            ...
            label.supportEncoding = mEncoding;
    ...
    /// executed OnSelect;
    /// </summary>
    public System.Action CustomOnSelectEvent;
    public System.Action CustomOnDeselectEvent;
    ...
    protected virtual void OnSelect(bool isSelected)
    {
        ...
        {
            OnSelectEvent();
            if (CustomOnSelectEvent != null) CustomOnSelectEvent();
        }
        else
        {
            OnDeselectEvent();
            if (CustomOnDeselectEvent != null) CustomOnDeselectEvent();
        }
    }
        ...
        if (label != null && NGUITools.GetActive(this))
        {
			...
			)
			{
                ...
                if(Config.bANYSDK)
                {
				    ...
				    IOSKeyBoard.mKeyIn = label.text;

				    IOSKeyBoard.mKeyOut = label.text;
    ...
    protected string GetLeftText()
    {
        ...
        return (string.IsNullOrEmpty(mValue) || min < 0) ? string.Empty : mValue.Substring(0, min);
    }
