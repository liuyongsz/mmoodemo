namespace KBEngine
{
    ...
    public delegate void NetEventFunction(params object[] datas);
    /*
		事件模块
	...
	*/
    public class Event
    {
        public struct Pair
		{
            ...
            public NetEventFunction callBack;
		};
		...
		*/
		public static bool registerOut(object obj, string funcname)
		{
		...
		*/
        public static bool registerIn(object obj, string funcname)
        { 
			return register(events_in, funcname, obj, funcname);
		}
